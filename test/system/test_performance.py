...
import gc
import threading
from test.utils import SystemTestBase
...
class TestPerformance(SystemTestBase):
    ...
    def test_function_call_performance(self):
        ...
        # Should be very fast
        assert per_call < 0.001, f"CUDA calls too slow: {per_call:.6f}s per call"
...
class TestResourceUsage(SystemTestBase):
    ...
    def test_cpu_usage(self):
        ...
        print(f"✓ CPU usage: {cpu_time:.3f}s for 10k operations")
    ...
    def test_memory_efficiency(self):
        ...
        # Multiple cycles to test for accumulation
