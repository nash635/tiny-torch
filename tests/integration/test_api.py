...
from tests.utils import IntegrationTestBase
...
class TestPerformanceIntegration(IntegrationTestBase):
    ...
    def test_function_call_performance(self):
        ...
        # 100 calls should complete within a reasonable time (increased threshold for robustness)
        assert call_time < 10.0, f"100 CUDA availability checks took too long: {call_time:.2f}s"
